...
def DecomTimer(mins)
    ...
    if mins > 5 then
        CreateTimer("DecomTimer", 300000, 0, mins-5) //CHANGE!
    else
        CreateTimer("Decom", 300000, 0) //CHANGE!
    end
end
...
public def OnRoundStarted() //Change to OnRoundStarted once development is complete
